...
### {{< fa solid chart-line >}} PhD Unemployment Model [{{< fa brands github size=sm >}}](https://github.com/jflournoy/phd-unemployment-model)
...
### {{< fa solid heart-pulse >}} Garmin Health Data Analysis [{{< fa brands github size=sm >}}](https://github.com/jflournoy/garmin-analysis)
...
### {{< fa solid images >}} Image Generation Pipeline v2 [{{< fa brands github size=sm >}}](https://github.com/jflournoy/image-gen-pipe-v2)
...
### {{< fa solid brain >}} Understanding LLMs [{{< fa brands github size=sm >}}](https://github.com/jflournoy/understanding-llms)
...
### {{< fa solid camera >}} Image Organizer [{{< fa brands github size=sm >}}](https://github.com/jflournoy/image-organizer)
...
### {{< fa solid mountain-sun >}} Terrain Maker v2 [{{< fa brands github size=sm >}}](https://github.com/jflournoy/terrain-maker_v2)
