...
### {{< fa solid chart-line >}} PhD Unemployment Model [{{< fa brands github >}}](https://github.com/jflournoy/phd-unemployment-model)
...
### {{< fa solid heart-pulse >}} Garmin Health Data Analysis [{{< fa brands github >}}](https://github.com/jflournoy/garmin-analysis)
...
### {{< fa solid images >}} Image Generation Pipeline v2 [{{< fa brands github >}}](https://github.com/jflournoy/image-gen-pipe-v2)
...
### {{< fa solid book-open >}} Story Time [{{< fa brands github >}}](https://github.com/jflournoy/story-time)
...
### {{< fa solid brain >}} Understanding LLMs [{{< fa brands github >}}](https://github.com/jflournoy/understanding-llms)
...
### {{< fa solid camera >}} Image Organizer [{{< fa brands github >}}](https://github.com/jflournoy/image-organizer)
...
### {{< fa solid people-arrows >}} Wealth Stratification Agent-Based Model [{{< fa solid globe >}}](http://johnflournoy.science/wealth-strat_abm/) [{{< fa brands github >}}](https://github.com/jflournoy/wealth-strat_abm)
...
### {{< fa solid mountain-sun >}} Terrain Maker v2 [{{< fa brands github >}}](https://github.com/jflournoy/terrain-maker_v2)
...
### {{< fa solid file-lines >}} No Silver Bullets: Software Cycle Time [{{< fa solid globe >}}](http://johnflournoy.science/no-silver-bullets/) [{{< fa brands github >}}](https://github.com/jflournoy/no-silver-bullets)
...
### {{< fa brands docker >}} verse-cmdstan [{{< fa brands github >}}](https://github.com/jflournoy/verse-cmdstan)
