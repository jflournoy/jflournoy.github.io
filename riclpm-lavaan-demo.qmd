...
date: "2017-10-20"
aliases:
  - /2017/10/20/riclpm-lavaan-demo/
format:
  html:
    toc: true
---

:::{.callout-note .badge-vapor .lead}

Hey! While you're here, you should know that I'm looking for new consulting contracts and employment opportunities. Feel free to [reach out](/consulting.html) if you'd like to chat about how I can help your team!
...
The variables we're considering are a measure of antisocial behavior (`anti`) and reading recognition (`read`). See the docs for descriptions of the other variables. And for the purpose of the model fitting below, `x <- anti` and `y <- read`. Following are some descriptions of the raw data:
...
![](figs/riclpm-lavaan-demo/Plot predictions-1.png)
...
![](figs/riclpm-lavaan-demo/Plot clpm-1.png)
...
![](figs/riclpm-lavaan-demo/Plot raw data scatter-1.png)
